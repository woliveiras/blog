...
![Acessar ssh]({{site.url}}/images/acessando-ssh-com-putty.png)
...
![Configuração do Putty]({{site.url}}/images/carregando-a-chave-ppk-putty.png)
...
![Primeiro acesso]({{site.url}}/images/primeiro-acesso-ssh-putty.png)
