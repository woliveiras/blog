...
![Configurações de disco no VBOX]({{site.url}}/images/disco-virtualbox-vagrant.png)
...
![Configurações de Rede VBox]({{site.url}}/images/rede-virtualbox-vagrant.png)
...
![Inserindo VBox Additions]({{site.url}}/images/guest-additions-vagrant.png)
...
![Nome da VM]({{site.url}}/images/nome-base-box-vagrant.png)
