...
![Novo repositório configurado e com os arquivos]({{site.post_images}}novo-repo-configurado.png)
...
No próximo artigo vamos configurar nosso ambiente de trabalho para começar aprender programação!
