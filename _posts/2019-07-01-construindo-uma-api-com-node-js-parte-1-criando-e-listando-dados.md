...
```javascript
{
    "nome": "William",
    "idade": "28",
    "contato": "https://twitter.com/etc_william"
}
```
...
Me acompanhe no Twitter para saber quando lançar alguma coisa aqui no Blog: [@etc_william](https://twitter.com/etc_william).
