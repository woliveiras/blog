...
![Confirmação do App Engine]({{site.post_images}}google-cloud-platform-app-engine-ok.png)
...
Se quiser acompanhar todo o conteúdo, me acompanhe no [Twitter](https://twitter.com/etc_william), se inscreva no [meu canal](https://youtube.com/ouniversodaprogramacao) ou me adicione no [LinkedIn](https://linkedin.com/in/william-oliveira).
