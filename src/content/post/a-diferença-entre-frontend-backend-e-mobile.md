...
title: Qual a diferença entre frontend, backend e mobile
excerpt: Um artigo para desmistificar as diferentes especialidades de uma pessoa desenvolvedora de software.
image: ~/assets/images/posts/diferent-drinks.jpeg
category: Carreira
tags:
  - carreira
  - programação
...
| Profissão | Plataforma                 | Precisa se preocupar com diversas plataformas? | Lida com dados vindo de terceiros? | Precisa persistir dados na plataforma? | Precisa se preocupar com sessão de usuário? | Precisa se preocupar com a camada de rede? | Precisa se preocupar com o funcionamento offline da aplicação? | Precisa se preocupar com infraestrutura? | Precisa se preocupar com cache de dados? | Precisam dominar várias bibliotecas | Precisam dominar frameworks? |
| --------- | -------------------------- | ---------------------------------------------- | ---------------------------------- | -------------------------------------- | ------------------------------------------- | ------------------------------------------ | -------------------------------------------------------------- | ---------------------------------------- | ---------------------------------------- | ----------------------------------- | ---------------------------- |
| Backend   | Sistema Operacional        | Sim                                            | Sim                                | Sim                                    | Sim                                         | Sim                                        | Não                                                            | Talvez                                   | Sim                                      | Sim                                 | Sim                          |
| Mobile    | Sistema Operacional Mobile | Sim                                            | Sim                                | Sim                                    | Sim                                         | Sim                                        | Sim                                                            | Talvez                                   | Sim                                      | Sim                                 | Sim                          |
| Frontend  | Navegador                  | Sim                                            | Sim                                | Sim                                    | Sim                                         | Sim                                        | Sim                                                            | Talvez                                   | Sim                                      | Sim                                 | Sim                          |

_Tabela de relacionamento entre profissões_
