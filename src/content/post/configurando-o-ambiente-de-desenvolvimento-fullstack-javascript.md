...
image: '~/assets/images/posts/jonatan-pie-216311-unsplash.jpg'
...
tags:
  ...
  - programação
  - ferramentas
excerpt: Para trabalhar com programação precisamos de um bom editor de textos e do ambiente de execução da nossa linguagem de programação. Neste artigo vamos conhecer um editor legal e aprender a instalar versões do Node.js, que irá executar nosso código JavaScript.
---
...
![Editor de textos simples com um código JavaScript](~/assets/images/posts/TextEdit-JavaScript.png)

![VS Code com um código JavaScript](~/assets/images/posts/VSCode-JavaScript.png)
