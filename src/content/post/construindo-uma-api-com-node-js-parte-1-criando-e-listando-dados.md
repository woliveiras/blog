...
image: '~/assets/images/posts/ed-van-duijn-2uTjeMfeVEU-unsplash.jpg'
category: Curso de Desenvolvimento de Software para iniciantes
tags:
  - javascript
  - nodejs
  - express
excerpt: Já sabemos utilizar o Node.js para construir CLIs, Express para criar um site e agora vamos aprender a construir APIs! Neste artigo vamos até a parte de criação e listagem de dados, mas o objetivo é construir um CRUD que você pode até usar como portfólio ou nos futuros hackathons por aí. :)
---
...
![Imagem do VS Code executando o comando npm run dev](~/assets/images/posts/vs-code-comando-npm-run-dev.png)

**Navegador acessando localhost:3000:**

![Imagem do Google Chrome exibindo o conteúdo de localhost:3000](~/assets/images/posts/chrome-api-localhost.png)
...
Será necessário criar uma conta na plataforma para então criarmos nossos _clusteres_ de bancos de dados. Não se preocupe, será tudo gratuito. :smile:
...
![Imagem da criação do projeto](~/assets/images/posts/create-a-project-atlas-mongodb.png)
...
![Imagem de confirmação com email de administrador](~/assets/images/posts/create-a-project-atlas-mongodb-admin-email.png)

Agora temos uma tela para criação de um Cluster, onde vamos armazenar nossos dados.

![Imagem do botão de criação de clusters](~/assets/images/posts/create-a-project-atlas-mongodb-create-a-cluster.png)
...
![Imagem da criação de cluster no free tier](~/assets/images/posts/create-a-project-atlas-mongodb-free-tier.png)

Irá aparecer uma mensagem de andamento da criação do Cluster.

![Imagem da mensagem de andamento de criação do Cluster](~/assets/images/posts/create-a-project-atlas-mongodb-creating-a-cluster.png)

Assim que estiver tudo pronto, teremos as métricas de acesso do cluster em nossa tela.

![Imagem das métricas do cluster](~/assets/images/posts/create-a-project-atlas-mongodb-clusters.png)
...
![Imagem da tela de usuários do cluster](~/assets/images/posts/create-a-project-atlas-mongodb-cluster-users.png)
...
![Tela de criação de usuário](~/assets/images/posts/create-a-project-atlas-mongodb-cluster-users-creating.png)
...
![Imagem da connection string](~/assets/images/posts/create-a-project-atlas-mongodb-connection-string.png)
...
![Tela inicial do Postman, com mensagem de boas vindas](~/assets/images/posts/postman-welcome-page.png)

Pode clicar no botão fechar e vamos aprender a fazer chamadas com o software.

![Interface do Postman](~/assets/images/posts/postman-interface.png)
...
![Resposta de localhost:300 no Postman](~/assets/images/posts/postman-localhost-3000.png)
...
![Postman com a resposta vazia do GET em localhost:3000/mentions](~/assets/images/posts/postman-list-data-empty.png)
...
![Imagem de uma requisição post no Postman](~/assets/images/posts/postman-full-post-requisition.png)
...
![Imagem de sucesso no Postman](~/assets/images/posts/postman-success-post-message.png)
...
![Imagem do Postman com o retorno OK da API](~/assets/images/posts/postman-listing-data.png)
...
- Limpar a resposta do GET mentions que está retornando informações inúteis para o usuário, como "\_id" e "\_\_v"
