...
image: '~/assets/images/posts/artur-luczka-loAfOVk1eNc-unsplash.jpg'
category: Curso de Desenvolvimento de Software para iniciantes
tags:
  - javascript
  - nodejs
  - express
excerpt: Já aprendemos a criar uma API com Node.js, Express, MongoDB e o Atlas, organizar nosso código utilizando repository, construímos nossos métodos de inserção e listagem. Agora vamos aprender a criar os métodos para atualização e remoção de dados no banco.
---
...
![Imagem do Atlas e os IDs das minhas menções](~/assets/images/posts/atlas-listing-collections.png)
...
![Imagem de uma deleção no Postman](~/assets/images/posts/postman-delete-data.png)
