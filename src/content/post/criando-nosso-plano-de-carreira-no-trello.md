...
tags:
  ...
  - pessoal
  - produtividade
excerpt: Dicas para organização da carreira utilizando metas, planos e o Trello
---
...
![Board com as colunas backlog, todo, doing e done](~/assets/images/posts/board-com-colunas-backlog-doing-done.png)
...
![Board com os limitadores de tarefas, como Todo (5) e Doing (5)](~/assets/images/posts/board-com-colunas-backlog-doing-done-limitadas.png)
...
![Coluna following](~/assets/images/posts/board-com-coluna-follow.png)
...
![Card de metas de longo prazo](~/assets/images/posts/board-com-card-metas-longo-prazo.png)
...
![Metas de longo prazo, conforme descrito na lista acima](~/assets/images/posts/card-metas-longo-prazo.png)
...
![Card com metas do ano de 2018, como "aprender backend", "melhorar no inglês", "aprimorar conhecimentos em JavaScript", "testes de software", etc](~/assets/images/posts/metas-do-ano.png)
...
![Card com as tarefas para dominar JavaScript, como: "comprar o livro xyz, que é muito recomendado pela comunidade", "ler x páginas do livro por dia", "criar um projeto para praticar esses conhecimentos", "escrever artigos sobre o que estou aprendendo"](~/assets/images/posts/card-com-metas-para-aprender-javascript.png)
...
![Imagem do board inteiro com todas as colunas e cards informados até aqui](~/assets/images/posts/board-inteiro.png)
...
![Board inteiro com os cards com as cores informadas](~/assets/images/posts/board-inteiro-com-labels.png)
