...
image: '~/assets/images/posts/kevin-horvat-1354011-unsplash-min.jpg'
...
tags:
  ...
  - infraestrutura
  - produtividade
excerpt: Uma introdução ao terminal. Sua história, a diferença entre utilizar interface gráfica e utilizar o terminal e comandos iniciais.
---
...
![Imagem do MS-DOS](~/assets/images/posts/MS-DOS.png)
...
Isso é a minha pasta _home_ que está na raiz da tabela de partições do meu HD. A pasta home é onde ficam os arquivos de usuário comum em sistemas operacionais Linux.
...
Agora eu quero acessar a pasta _Desktop_. Para isso eu posso digitar **cd Desktop** ou então digitar **cd Des** e pressionar o TAB que o terminal irá autocompletar o nome do diretório para mim. Caso eu esteja tentando entrar em um diretório que não existe, o TAB não vai funcionar.
...
Caso nossa necessidade fosse acessar a pasta _boletos_ e estivéssemos em _/home_, precisaríamos rodar: `cd /home/Pictures/boletos`.
