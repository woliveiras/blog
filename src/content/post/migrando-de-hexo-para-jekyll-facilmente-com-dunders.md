...
tags:
  ...
  - ferramentas
  - jamstack
excerpt: O processo de migraçãdo do meu blog de Hexo para Jekyll utilizando o Jekyll Template Dunders
---
...
_Com a vontade de migrar o blog para Jekyll, aproveitei para dar uma repaginada no layout do site alterando todo o tema. Eu não sou designer e por isso o tema pode estar meio feinho. Então, se tiver alguma dica para eu melhorar o layout, pode me dar um toque._
...
![Tempo gasto trabalhando com Sass na criação do tema](~/assets/images/posts/tempo-gasto-em-sass.png)
...
![Tempo gasto no VS Code](~/assets/images/posts/tempo-gasto-no-vscode.png)
...
![Codificando o novo tema](~/assets/images/posts/codando-o-novo-tema.png)
...
![Novo footer do site](~/assets/images/posts/footer-do-site.png)
