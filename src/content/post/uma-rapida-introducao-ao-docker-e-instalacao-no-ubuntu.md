...
excerpt: Uma rápida introdução ao Docker e instalação no Ubuntu para iniciantes. Dicas para não precisar de sudo ao executar o Docker e como iniciar o Docker junto com o Sistema Operacional.
---
...
Primeiro vamos entender de que _ambiente_ estamos falando.
...
Para verificar se está tudo rodando certinho, execute o container de _Hello World_ do Docker:
...
_OBS: `$USER` é uma variável do Shell para o usuário logado, caso esteja configurando para outro usuário, deve colocar o nome dele no lugar disso._
